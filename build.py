...
os.system("Kamek\\Kamek.exe build\\nsmbw-random-pipe.o -dynamic -versions=address-map.txt -externals=externals.txt -output-kamek=output\\nsmbw-pipe-randomizer\\Code\\E2.bin -select-version=E2")
os.system("Kamek\\Kamek.exe build\\nsmbw-random-pipe.o -dynamic -versions=address-map.txt -externals=externals.txt -output-kamek=output\\nsmbw-pipe-randomizer\\Code\\J1.bin -select-version=J1")
os.system("Kamek\\Kamek.exe build\\nsmbw-random-pipe.o -dynamic -versions=address-map.txt -externals=externals.txt -output-kamek=output\\nsmbw-pipe-randomizer\\Code\\J2.bin -select-version=J2")
os.system("Kamek\\Kamek.exe build\\nsmbw-random-pipe.o -dynamic -versions=address-map.txt -externals=externals.txt -output-kamek=output\\nsmbw-pipe-randomizer\\Code\\K.bin -select-version=K")
os.system("Kamek\\Kamek.exe build\\nsmbw-random-pipe.o -dynamic -versions=address-map.txt -externals=externals.txt -output-kamek=output\\nsmbw-pipe-randomizer\\Code\\W.bin -select-version=W")
